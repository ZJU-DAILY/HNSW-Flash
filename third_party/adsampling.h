...
unsigned int D = SUBVECTOR_NUM; // The dimensionality of the dataset.
float epsilon0 = ADSAMPLING_EPSILON;       // epsilon0 - by default 2.1, recommended in [1.0,4.0], valid in in [0, +\infty)
unsigned int delta_d = ADSAMPLING_DELTA_D; // dimension sampling for every delta_d dimensions.
